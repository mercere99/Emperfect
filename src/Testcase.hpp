...
public:
  ...
  void GenerateTestCPP(const std::string & header) {
    ...
    cpp_file
      ...
      << "  if constexpr (is_fun) {\n"
      << "    using return_t = FunInfo<T>::return_t;\n"
      ...
      << "    name += ')';\n"
      << "  }\n"
      << "  else if (name == typeid(char).name())        name = \"char\";\n"
      << "  else if (name == typeid(double).name())      name = \"double\";\n"
      << "  else if (name == typeid(int).name())         name = \"int\";\n"
      << "  else if (name == typeid(std::string).name()) name = \"std::string\";\n"

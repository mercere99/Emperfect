...
private:
  ...
  std::string cpp_filename;  // Name of file to create with C++ code for this test
  std::string output_filename;  // Name of file to create to store output generated by executable.
  std::string exe_filename;  // Name of file to create for executable
